...
playersUrl = 'https://www.futhead.com/19/players/?page='
playersPages = 210

goalKepeerUrl = 'https://www.futhead.com/19/players/?group=gk&page='
goalKepeerPages = 39

getPlayers(playersUrl, playersPages)
getPlayers(goalKepeerUrl, goalKepeerPages)


def getPlayers(baseUrl, pages):

	for page in range(1,pages):
		print("page: ", page)

		url = baseUrl + str(page) + '&bin_platform=ps'
		response = get(url)
